module Campfire
  class Rooms::OpensController < RoomsController
    ...
    def create
      room = Rooms::Open.create_for(room_params.merge(creator: current_campfire_user), users: current_campfire_user)

      # TODO: Fix helper availability in broadcast context
